...
const FLARE_ENERGY = 100;     // fixed cost per flare deploy (any ship class)
...
// Phaser cost is now a FIXED per-class quantum (set per ship in SHIPS below
// via phaserEnergy). Bigger reserves = more shots before depletion, instead
// of paying a proportional fraction every time. Same for flares (global 100).
...
const SHIPS = {
  SC: { id: "SC", name: "Scout",
        ...
        phaserDmg: 25, phaserRange: 1800, phaserCool: 0.2, phaserEnergy: 200,
        torpDmg: 60, torpRange: TORP_MAX_RANGE, torpEnergy: 200, torpCool: 0.45,
        torpMax: 4, torpReloadTime: 12.0, torpAccuracy: 1, torpAutoMaxPerLock: 3,
        shieldDrain: 5,
  ...
  DD: { id: "DD", name: "Destroyer",
        ...
        phaserDmg: 30, phaserRange: 2000, phaserCool: 0.2, phaserEnergy: 300,
        torpDmg: 75, torpRange: TORP_MAX_RANGE, torpEnergy: 260, torpCool: 0.55,
        torpMax: 6, torpReloadTime: 11.0, torpAccuracy: 1, torpAutoMaxPerLock: 3,
        shieldDrain: 7,
  ...
  CA: { id: "CA", name: "Cruiser",
        ...
        phaserDmg: 35, phaserRange: 2200, phaserCool: 0.2, phaserEnergy: 400,
        torpDmg: 90, torpRange: TORP_MAX_RANGE, torpEnergy: 320, torpCool: 0.6,
        torpMax: 8, torpReloadTime: 10.0, torpAccuracy: 1, torpAutoMaxPerLock: 3,
        shieldDrain: 9,
  ...
  BB: { id: "BB", name: "Battleship",
        ...
        phaserDmg: 40, phaserRange: 2400, phaserCool: 0.2, phaserEnergy: 500,
        torpDmg: 110, torpRange: TORP_MAX_RANGE, torpEnergy: 400, torpCool: 0.7,
        torpMax: 10, torpReloadTime: 8.0, torpAccuracy: 1, torpAutoMaxPerLock: 3,
        shieldDrain: 12,
  ...
  DG: { id: "DG", name: "Demi God",
        ...
        phaserDmg: 40, phaserRange: 2400, phaserCool: 0.2, phaserEnergy: 500, phaserAutoInterval: 0.2,
        torpDmg: 110, torpRange: TORP_MAX_RANGE, torpEnergy: 400, torpCool: 0.18,  // 0.18s allows 5/sec
        torpAutoBurstSize: 5, torpAutoBurstWindow: 1.0,  // flagship: 5 torps/sec on Auto-Fire
        torpAutoMaxPerLock: 10,  // flagship: up to 10 torps per locked target before requiring re-lock
...
// Helper — phaser energy cost for ship s. FIXED per-class quantum (def.phaserEnergy);
// having more max energy means more shots before depletion, not a higher cost per shot.
function phaserEnergyCost(s, world) {
  return shipDef(s).phaserEnergy || 500;  // fallback if class def missed
}
// Helper — flare deploy cost. Single global fixed quantum (FLARE_ENERGY = 100).
...
// Per-class auto-fire interval — bigger ships throttle harder, flagship-tier
// (Demi God) fires at the raw 0.2s cooldown.
function phaserAutoInterval(s) {
  return shipDef(s).phaserAutoInterval || AUTO_PHASER_INTERVAL;
}
